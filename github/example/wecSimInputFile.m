...
simu.simMechanicsFile = 'RM3_rackAndPinion_w_PEC.slx';      %Location of Simulink Model File with PTO-Sim                    
simu.startTime = 0;                     
simu.rampTime = 50;                       
simu.endTime = 200;   
simu.dt = 1e-3;                       
...
%% Additional WEC Parameter Definitions
wec.pRated = 2e6; % WEC rated power [W]
wec.nRackPinion = 1/40; % Rack and pinion gear ratio [-]
wec.bFric = 0.01; % WEC coefficient of friction [Nm*s/rad]
[wec.damping,~] = rm3optdampingcalcfun(waves.period, "damping");
